...
$isAS = get_page_template_slug() === 'advanced_search_results.php';
...
<div id="advanced_search_map_list">
    <div class="advanced_search_map_list_container">
        ...
        if( wprentals_get_option('wp_estate_use_geo_location','')=='yes' && !$isAS){
        ...
        <div class="advanced_search_map_list_container_trigger">
            ...
            if($isAS) {
                ...
                print  trim($search_object_adv->wpstate_display_search_form('half'));
