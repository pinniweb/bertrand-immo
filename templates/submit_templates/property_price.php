...
//    // WEEKEND days
    if(( array_key_exists ($timestamp_java,$mega_details)) ){
        ...
        if( array_key_exists  ($timestamp_java,$custom_price_array) ){
            ...
            $calendar_output .= '<span class="custom_set_price">'.wpestate_show_price_custom (  wpestate_display_price_simple($property_price,$price_per_guest_from_one,$extra_price_per_guest) ).'</span>';
        }

    }else if( $property_price_week!=0 ){
        // we have general price per weekend
        $calendar_output .= '<span class="custom_set_price weekend_set_price">2'.wpestate_show_price_custom (  wpestate_display_price_simple($property_price_week ,$price_per_guest_from_one,$extra_price_per_guest) ).'</span>';
    }else if(( array_key_exists ($timestamp_java,$custom_price_array) && floatval( $custom_price_array[$timestamp_java]) !=0) ){
        $calendar_output .= '<span class="custom_set_price weekend_set_price">3'. wpestate_display_price_simple($custom_price_array[$timestamp_java] ,$price_per_guest_from_one,$extra_price_per_guest) .'</span>';
    }else{
        // no weekedn price
...
<div class="col-md-12">
    ...
    <input type="hidden" id="min_days_booking" name="min_days_booking" value="7">
    <input type="hidden" id="checkin_checkout_change_over" name="checkin_checkout_change_over" value="6">
    <input type="hidden" id="cleaning_fee_per_day" name="cleaning_fee_per_day" value="0">
    <div class="row">
    <?php
    ...
    ?>
        ...
        <?php
        wp_enqueue_script('calc_price_convert_js',trailingslashit( get_stylesheet_directory_uri() ).'js/calc_price_convert.js',array('jquery'), '1.0', true);



        $terms = get_the_terms( $edit_id, 'property_category' );
            ...
            switch ($terms[0]->slug){
                case 'vente' : ?>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-3">
                            <label  class="label_adjust" for="property_price">Prix</label>
                            <input type="number" id="property_price" class="form-control" size="40" name="property_price" value="<?php print esc_html($property_price);?>">
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-3">
                            <label  class="label_adjust" for="property_price">
                                ...
                                ?> en € (chiffre seulement)
                            </label>
                            <input type="number" id="property_price" class="form-control kbi_calc_price_day_to_week" size="40" name="property_price" value="<?php print esc_html($property_price);?>">
                        </div>
                        <div class="col-md-3">
                            <label  class="label_adjust" for="property_k_price_week">
                                Tarif/Semaine en € (chiffre seulement)
                            </label>
                            <input type="number" id="property_k_price_week" class="form-control kbi_calc_price_week_to_day" size="40" name="property_k_price_week" value="<?php print esc_html(intval($property_price*7));?>">
                        </div>
                    </div>
    ...
    <?php }
    if($terms[0] && $terms[0]->slug !== 'vente' && $terms[0]->slug !== 'location'):  ?>

        <?php if(is_array($submission_page_fields) && in_array('property_taxes', $submission_page_fields)) {
        ?>
        
        <div class="col-md-12">
            <div class="col-md-3 dashboard_chapter_label">
                <label for="property_taxes"> Frais de ménage </label>
            </div>
            <div class="col-md-3">
                <label for="property_taxes"> Frais de ménage en € (chiffre seulement) </label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div id="booking_form_request_mess_modal"></div>
                    ...
                    <input name="period_checkin_change_over" type="hidden"  id="period_checkin_change_over" value="6">
                    <input name="period_checkin_checkout_change_over" type="hidden"  id="period_checkin_checkout_change_over" value="6">

                    <div class="col-md-6">
                        <label class="label_adjust" for="property_price">
                            Tarif/nuit en € (chiffre seulement)
                        </label>
                        <input type="number" id="new_custom_price" class="form-control kbi_calc_price_day_to_week" size="40" name="new_custom_price">
                    </div>
                    <div class="col-md-6">
                        <label class="label_adjust" for="property_k_price_week">
                            Tarif/Semaine en € (chiffre seulement)
                        </label>
                        <input type="number" id="property_k_price_week" class="form-control kbi_calc_price_week_to_day" size="40" name="property_k_price_week">
                    </div>
