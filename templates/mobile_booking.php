...
<div class="mobile_booking_wrapper">
  ...
  <button
    class="wpb_btn-info wpb_regularsize wpestate_vc_button  vc_button"
    id="mobile_booking_triger"
    style="width: 95%; display: block; margin-left: 10px;"
    >
