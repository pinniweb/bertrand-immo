...
<?php if(empty($kbi_tabs_search)): ?>
    ...
    <h1  style="margin-left: 20px;margin-bottom: 0;font-family: 'Roboto', Sans-serif;font-size: 4rem;font-weight: 200;text-transform: uppercase;letter-spacing: 1px;">Location de logements</h1>
<?php endif; ?>

<form action="/location/" id="kbi_loc_search_form">
    <input type="hidden" id="property_category_loc" name="property_category" value="location">
    <div class="row">
        <div class="col-md-4">
            ...
            <div class="dropdown form-control dropdown custom_icon_class icon_actionslist form-control">
                <div data-toggle="dropdown" id="adv_actions_loc" class="filter_menu_trigger " data-value="<?php echo esc_attr(strtolower ( rawurlencode ( $adv_actions_value1) )) ?>">
                    <?php echo $adv_actions_value ; ?>
                    <span class="caret caret_filter"></span>
                </div>
                <input type="hidden" id="property_action_category_loc" name="property_action_category" value="<?php echo !empty($_GET['property_action_category'])?strtolower( esc_attr($_GET['property_action_category']) ):'' ?>">
                <ul  class="dropdown-menu filter_menu" role="menu" aria-labelledby="adv_actions_loc">
        ...
        <div class="col-md-4">
            ...
            <div class="dropdown form-control dropdown custom_icon_class icon_actionslist form-control">
                <div data-toggle="dropdown" id="property_bedrooms_toogle_loc" class="filter_menu_trigger " data-value="chambres">
                    <?php echo !empty($_GET['property_bedrooms'])?strtolower( esc_attr($_GET['property_bedrooms']) ):'Chambres' ?>
                    <span class="caret caret_filter"></span>
                </div>
                <input type="hidden" id="property_bedrooms_loc" name="property_bedrooms" value="<?php echo !empty($_GET['property_bedrooms'])?strtolower( esc_attr($_GET['property_bedrooms']) ):'' ?>">
                <ul class="dropdown-menu filter_menu" role="menu" aria-labelledby="property_bedrooms_toogle_loc">
        ...
        <div class="col-md-4">
            <input type="text" id="property_mandat_loc" name="property_mandat" placeholder="Référence" class="form-control" value="<?php echo !empty($_GET['property_mandat'])?strtolower( esc_attr($_GET['property_mandat']) ):'' ?>">
        </div>

        <div class="col-md-12">
            <i class="custom_icon_class_icon fas fa-map-marker"></i>
            <div class="dropdown form-control dropdown custom_icon_class icon_actionslist form-control">
                <div data-toggle="dropdown" id="adv_city_loc" class="filter_menu_trigger " data-value="<?php echo esc_attr(strtolower ( rawurlencode ( $adv_cities_value1) )) ?>">
                    <?php echo $adv_cities_value ; ?>
                    <span class="caret caret_filter"></span>
                </div>
                <input type="hidden" id="property_city_loc" name="property_city" value="<?php echo !empty($_GET['property_city'])?strtolower( esc_attr($_GET['property_city']) ):'' ?>">
                <ul  class="dropdown-menu filter_menu" role="menu" aria-labelledby="adv_city_loc">
    ...
    <div class="row">
        <?php if(!empty($kbi_tabs_search)): ?>
            <div class="col-md-8">
                <?php echo wpestate_price_form_adv_search('kbi_loc', '', ''); ?>
            </div>
            <div class="col-md-4">
...
<script>
  jQuery(document).ready(function($) {
    $('#kbi_loc_search_form .dropdown-menu li').on('click',function () {
...
<style>
    #kbi_loc_search_form .custom_icon_class_icon {margin-left: 15px;}
    #kbi_slider_loc{
        height: 6px;
        margin: 10px 10px 6px 10px;
        background-color: #e9edf3!important;
    }
    #kbi_slider_loc .ui-slider-handle{
        border-radius: 1px;
    ...
    #kbi_slider_loc .ui-slider-range{
