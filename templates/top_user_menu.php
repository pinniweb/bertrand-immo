...
if ( 0 != $current_user->ID  && is_user_logged_in() ) {
    ...
    <div id="user_menu_open"> 
        ...
        <?php if($home_url!=$dash_favorite && !wpestate_check_user_level()){?>
        ...
        if( $dash_allinone!=$home_url && $dash_allinone!="" && wpestate_check_user_level() ){ ?>
            <a href="<?php print esc_url($dash_allinone);?>" class="active_fav"><i class="far fa-calendar-alt"></i><?php esc_html_e('All In One Calendar','wprentals');?></a>
        <?php }
