...
$property_ref = '';
if( isset($_POST['wpestate_prop_ref']) ){
    $property_ref=sanitize_text_field($_POST['wpestate_prop_ref']);
}

$property_mandat = '';
if( isset($_POST['wpestate_prop_mandat']) ){
    $property_mandat=sanitize_text_field($_POST['wpestate_prop_mandat']);
}
?>
...
<div class="row is_dashboard">
    ...
    <div class=" dashboard-margin">
        ...
        if($title_search!='' || $property_mandat !='' || $property_ref != ''){
            if ($title_search!='') {
                $args['s'] = $title_search;
            }
            if ($property_ref) {
