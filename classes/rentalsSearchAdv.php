...
class WpRentalsSearchAdv {
    ...
    */
    function display_search_fields($position){
        $return_string =   '';
        $return_string.=  '<div>';
        $return_string.=  '<i style="margin-left: 20px;" class="custom_icon_class_icon fa fa-search"></i>';
        $return_string.=  '<input type="text" id="kbi_search" name="search" placeholder="Rechercher par titre ou reference" class="advanced_select form-control custom_icon_class_input kbi_input" value="'.wp_kses(!empty($_GET["search"])?$_GET["search"]:"", array()).'">';
        $return_string.=  '<input type="hidden" id="kbi_search_page" value="1"/>';
        $return_string.=  '</div>';
