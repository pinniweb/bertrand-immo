...
if (!function_exists('wpestate_get_booking_data')):
    ...
    function wpestate_get_booking_data()
    {
        ...
        print'<div class="allinone-booking-data-guests">Client : '. $display_name.'</div>';
...
if (!function_exists('wpestate_ajax_filter_listings')):
    ...
    function wpestate_ajax_filter_listings()
    {
        ...
        if (isset($_POST['mandat'])) {
            $taxmandat = sanitize_title(wp_kses($_POST['mandat'], $allowed_html));
            $mandat_array = array(
                'key'  => 'property_mandat',
                'value'     => $taxmandat,
                'compare' => 'LIKE'
