...
if( !function_exists('wpestate_price_form_adv_search') ): 
    function wpestate_price_form_adv_search($position,$slug,$label){
        ...
        }else if($position=='kbi_vente') {
            $slider_id      =   'kbi_slider_vente';
            $price_low_id   =   'price_low_vente';
            $price_max_id   =   'price_max_vente';
            $ammount_id     =   'amount_vente';

        }else if($position=='kbi_loc') {
            $slider_id      =   'kbi_slider_loc';
            $price_low_id   =   'price_low_loc';
            $price_max_id   =   'price_max_loc';
            $ammount_id     =   'amount_loc';

        }else if($position=='kbi_loc_saison') {
            $slider_id      =   'kbi_slider_loc_saison';
            $price_low_id   =   'price_low_loc_saison';
            $price_max_id   =   'price_max_loc_saison';
            $ammount_id     =   'amount_loc_saison';

        }

        $min_price_slider   = ( floatval(wprentals_get_option('wp_estate_show_slider_min_price','')) );
        $max_price_slider   = $position=='kbi_vente' ? ( floatval(wprentals_get_option('wp_estate_show_slider_max_price','')) ) : 2000;
