...
function wpestate_scripts() {
    ...
    wp_enqueue_script('recall_form',get_stylesheet_directory_uri(). '/js/recall_form.js');
    ...
    wp_enqueue_script('quill', 'https://cdn.quilljs.com/1.3.6/quill.js');
    ...
    if( get_post_type() === 'estate_property' && !is_tax() && !is_search() && !is_tag() ){
        ...
        wp_enqueue_script('wpestate_googlecode_regular', trailingslashit( get_stylesheet_directory_uri() ).'js/google_js/google_map_code.js',array('jquery','wpestate_mapfunctions_base'), '1.0', true);
...
if ( is_page_template('user_dashboard_edit_listing.php') || is_page_template('property_list_half.php')  ){
    ...
    if($load_extra ==   1){
        ...
        wp_enqueue_script('wpestate_mapfunctions_base', trailingslashit( get_stylesheet_directory_uri() ).'js/google_js/maps_base.js',array('jquery','wpestate_mapfunctions','wpestate_ajaxcalls'), '1.0', true);
...
//     vente
    $adv_search_kbi_vente = array(
        'Vente' => 'Vente',
        'guest_no' => 'guest_no',
        'check_in' => 'check_in',
        'check_out' => 'check_out',
        'property_category_vente' => 'property_category',
        'property_action_category_vente' => 'property_action_category',
        'property_bedrooms_vente' => 'property_bedrooms',
        'property_bathrooms_vente' => 'property_bathrooms',
        'property_city_vente' => 'property_city',
        'property_price_vente' => 'property_price',
        'property_mandat_vente' => 'property_mandat'
    );

//  location
    $adv_search_kbi_loc = array(
        'Vente' => 'Vente',
        'guest_no' => 'guest_no',
        'check_in' => 'check_in',
        'check_out' => 'check_out',
        'property_category_loc' => 'property_category',
        'property_action_category_loc' => 'property_action_category',
        'property_bedrooms_loc' => 'property_bedrooms',
        'property_bathrooms_loc' => 'property_bathrooms',
        'property_city_loc' => 'property_city',
        'property_price_loc' => 'property_price',
        'property_mandat_loc' => 'property_mandat'
    );

//  loc_saison
    $adv_search_kbi_loc_saison = array(
        'Vente' => 'Vente',
        'guest_no' => 'guest_no',
        'check_in' => 'check_in',
        'check_out' => 'check_out',
        'property_category_loc_saison' => 'property_category',
        'property_action_category_loc_saison' => 'property_action_category',
        'property_bedrooms_loc_saison' => 'property_bedrooms',
        'property_bathrooms_loc_saison' => 'property_bathrooms',
        'property_city_loc_saison' => 'property_city',
        'property_price_loc_saison' => 'property_price',
        'property_ref_loc_saison' => 'property_ref'
    );
    ...
    wp_localize_script('wpestate_ajaxcalls', 'ajaxcalls_vars',
            array(  'contact_name'          =>  esc_html__( 'Your Name','wprentals'),
                    ...
                    'adv_search_kbi_vente'      =>  $adv_search_kbi_vente,
                    'adv_search_kbi_loc'        =>  $adv_search_kbi_loc,
                    'adv_search_kbi_loc_saison' =>  $adv_search_kbi_loc_saison,
    ...
    if( ( isset($post->ID) && wpestate_check_if_admin_page($post->ID) )  ||  ( 'estate_property' == get_post_type() )  ){
        ...
        wp_enqueue_script('select2_js', 'https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js',array('jquery'), '1.0', true);
        wp_enqueue_style('select2_css', 'https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css', array(), '1.0', 'all');
    ...
    if ( is_user_logged_in() ) {
        ...
        wp_register_script('wpestate_property', trailingslashit( get_stylesheet_directory_uri() ).'js/property.js',$property_js_required, '1.0', true);
    ...
    if(!is_search() && !is_404() && !is_tax() && !is_category() && !is_tag()){
        ...
        //if( wpestate_check_if_admin_page($post->ID) || is_singular('estate_property') ){
                ...
                wp_register_script('wpestate_dashboard-control', trailingslashit( get_stylesheet_directory_uri() ).'js/dashboard-control.js',array('jquery'), '1.0', true);
